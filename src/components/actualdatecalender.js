...
class MaterialCalender {
    ...
    toogleCalender(boolean) {
        ...
        projectnavigation.actual.materialdate.materialcalender = boolean;
    ...
    showicon() {
        ...
        if (this.props.projectnavigation.actual.materialdate.materialcalender) {
            return (
    ...
    showlabel() {
        ...
        const styles = MyStylesheet();
        if (this.props.projectnavigation.actual.materialdate.materialcalender) {
            let day = this.props.projectnavigation.actual.materialdate.materialdateday;
            let year = this.props.projectnavigation.actual.materialdate.materialdateyear;
            let month = this.props.projectnavigation.actual.materialdate.materialdatemonth;
    ...
    activecell(num) {
        if (Number(num) === Number(this.props.projectnavigation.actual.materialdate.materialdateday)) {
