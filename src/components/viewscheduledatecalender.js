...
class MaterialCalender {
    ...
    showicon() {
        ...
        if (this.state.showcalender) {
            return (
                <button style={{ ...styles.generalButton, ...removeIcon }} onClick={() => { this.setState({ showcalender: false }) }}>{removeIconSmall()} </button>
            )
        } else {
            return (
                <button style={{ ...styles.generalButton, ...dropIcon }} onClick={() => { this.setState({ showcalender: true }) }}>{dropDateIcon()} </button>
            )
        }
