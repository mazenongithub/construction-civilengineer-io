   ...
   handleEquipmentCosts() {
     ...
     for (let costdb of costsdb) {
       ...
       if(costid === costiddb) {
         ...
         if(getcostdb != getcost || dateindb != datein || detaildb !=detail) {
           
           this.response.equipment.cost.update.push({equipmentiddb,costid:costiddb, cost:getcost, datein, detail})
         }
       ...
       if(deletecost) {
          ...
          this.response.equipment.cost.delete.push({equipmentiddb, costid:costiddb})
      ...
      for (let cost of costs) { 
       ...
       let equipmentiddb = costdb.equipmentid;
        ...
        if(insert) {
          ...
          this.response.equipment.cost.insert.push({equipmentid, costid, cost:getcost, datein, detail})
        }
       ...
       if(equipment.ownership) {
         ...
         if(equipment.ownership.cost) {
           ...
           for(let cost of equipment.ownership.cost) {
             ...
             let costid = cost.costid;
             let detail = cost.detail;
             let datein = cost.datein;
             let getcost = cost.cost;
             
             costs.push({equipmentid, costid, detail, getcost:cost, datein})
        ...
        for (let equipmentdb of equipmentsdb) {
            ...
            let deleteequipment = true;
             ...
             if(equipmentdb.rented) {
                ...
                salvagedb =equipmentdb.ownership.salvage;
            ...
            for (let equipment of equipments) {
              ...
              if(equipment.rented) {
                ...
                salvage =equipment.ownership.salvage;
                ...
                if (equipmentid === equipmentiddb) {
                    deleteequipment = false;
                       ...
                       if(equipment.rented) {
                         ...
                         if(getequipmentdb != getequipment || accountid != accountiddb || getequipmentdb != getequipment || accountid != accountiddb || weekly != weeklydb || hourly != hourlydb || daily != dailydb || monthly != monthlydb) {
                           
                             this.response.equipment.update.push({ equipmentid, equipment: getequipment, accountid, weekly, monthly, daily, hourly })
                        ...
                        if(getequipmentdb != getequipment || accountid != accountiddb || salvage != salvagedb || purchasedate != purchasedatedb || saledate != saledatedb || purchase != purchasedb || loaninterest != loaninterestdb || workinghours != workinghoursdb) {
                          
                           this.response.equipment.update.push({ equipmentid, equipment: getequipment, accountid, salvage, purchasedate, saledate, purchase, loaninterest, workinghours })
