...
class Project extends Component {
    ...
    componentDidMount() {
        ...
        this.findproject(companyid, projectid)
    ...
    reset() {
        ...
        this.timeindefault(projectnavigation)
        this.timeoutdefault(projectnavigation);
        this.materialdatedefault(projectnavigation);
    ...
    async findproject(companyid, projectid) {
        const construction = new Construction();

        try {

            let response = await FindProject(companyid, projectid)
            ...
            if (response.hasOwnProperty("myproject")) {
                ...
                if(response.hasOwnProperty("pm")) {
                    getproject.milestones = response.pm.milestones;
                    getproject.team = response.pm.team
                }
                ...
                this.createProjectSocket(project_id)
    ...
    createProjectSocket(project_id) {
    ...
    handleNavigation(navigation) {
        ...
        } else if (navigation === "bidschedule") {
    ...
    Navigation() {
        ...
        if (projectnavigation.hasOwnProperty("schedule")) {
            ...
            } else if (projectnavigation.hasOwnProperty("bidschedule")) {
        ...
        } else if (projectnavigation.hasOwnProperty("bid")) {
        ...
        } else if (projectnavigation.hasOwnProperty("actual")) {
